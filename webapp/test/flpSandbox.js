		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order Details",
									"targetURL": "#masterdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterdetails-display": {
								"semanticObject": "masterdetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterdetails",
									"url": sap.ui.require.toUrl("masterdetails")
								}
							}
						}
					}
